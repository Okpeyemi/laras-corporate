...
const Hero = () => {
  return (
    <div className="bg-gradient-to-b from-primary to-foreground max-xl:mt-20 mt-24 h-[700px] max-md:h-[500px] flex flex-col items-start justify-center text-background responsive space-y-10">
      <div className="text">
        <h1>Médical & Santé.</h1>
